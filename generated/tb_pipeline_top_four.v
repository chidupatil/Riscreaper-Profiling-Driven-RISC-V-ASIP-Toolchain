// ============================================================
// Module      : tb_pipeline_top_four
// Description : Program-specific RICH-DEBUG testbench for four
...
module tb_pipeline_top_four;
    ...
    initial begin
        $dumpfile("tb_pipeline_top_four.vcd");
        $dumpvars(0, tb_pipeline_top_four);
    end
    ...
    initial begin
        ...
        $display("This build stores these registers: [1, 2, 8, 10, 11, 14, 15]");
        $display("############################################################");
        $display("");
    ...
    initial begin
        ...
        $display("FAIL absolute timeout in tb_pipeline_top_four.v");
        $finish;
    end
endmodule
