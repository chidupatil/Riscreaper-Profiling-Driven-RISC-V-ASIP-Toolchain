// ============================================================
// Module      : tb_pipeline_top_dsp
// Description : Program-specific RICH-DEBUG testbench for dsp
...
module tb_pipeline_top_dsp;
    ...
    initial begin
        $dumpfile("tb_pipeline_top_dsp.vcd");
        $dumpvars(0, tb_pipeline_top_dsp);
    end
    ...
    initial begin
        ...
        $display("FAIL absolute timeout in tb_pipeline_top_dsp.v");
        $finish;
    end
endmodule
