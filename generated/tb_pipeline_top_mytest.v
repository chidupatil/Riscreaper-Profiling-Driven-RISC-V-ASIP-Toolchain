// ============================================================
// Module      : tb_pipeline_top_mytest
// Description : Program-specific RICH-DEBUG testbench for mytest
...
module tb_pipeline_top_mytest;
    ...
    wire [9:0] dbg_alu_result_ex;
    wire dbg_branch_taken_ex;
    wire dbg_mem_write_mem;
    wire [9:0] dbg_mem_addr_mem;
    wire [9:0] dbg_mem_wdata_mem;
    wire dbg_reg_write_wb;
    wire [3:0] dbg_rd_wb;
    wire [9:0] dbg_wb_data;

    reg [9:0] last_wb_data;
    reg [3:0] last_wb_rd;
    reg last_wb_seen;
    reg [9:0] last_mem_addr;
    reg [9:0] last_mem_wdata;
    reg last_mem_seen;
    reg [9:0] last_a0_data;
    reg last_a0_seen;
    ...
    initial begin
        $dumpfile("tb_pipeline_top_mytest.vcd");
        $dumpvars(0, tb_pipeline_top_mytest);
    end
    ...
    initial begin
        ...
        $display("This build stores these registers: [1, 2, 5, 8, 10, 11, 12, 13, 14, 15]");
        $display("############################################################");
        $display("");
    ...
    initial begin
        ...
        $display("FAIL absolute timeout in tb_pipeline_top_mytest.v");
        $finish;
    end
endmodule
