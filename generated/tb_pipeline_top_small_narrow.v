// ============================================================
// Module      : tb_pipeline_top_small_narrow
// Description : Program-specific RICH-DEBUG testbench for small_narrow
...
module tb_pipeline_top_small_narrow;
    ...
    initial begin
        $dumpfile("tb_pipeline_top_small_narrow.vcd");
        $dumpvars(0, tb_pipeline_top_small_narrow);
    end
    ...
    initial begin
        ...
        $display("This build stores these registers: [1, 2, 8, 10, 14, 15]");
        $display("############################################################");
        $display("");
    ...
    initial begin
        ...
        $display("FAIL absolute timeout in tb_pipeline_top_small_narrow.v");
        $finish;
    end
endmodule
