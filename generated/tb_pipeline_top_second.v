// ============================================================
// Module      : tb_pipeline_top_second
// Description : Program-specific RICH-DEBUG testbench for second
...
module tb_pipeline_top_second;
    ...
    initial begin
        $dumpfile("tb_pipeline_top_second.vcd");
        $dumpvars(0, tb_pipeline_top_second);
    end
    ...
    initial begin
        ...
        $display("This build stores these registers: [1, 2, 10]");
        $display("############################################################");
        $display("");
    ...
    initial begin
        ...
        $display("FAIL absolute timeout in tb_pipeline_top_second.v");
        $finish;
    end
endmodule
