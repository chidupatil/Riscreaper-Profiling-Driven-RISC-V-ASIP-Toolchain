// ============================================================
// Module      : tb_pipeline_top_small
// Description : Program-specific smoke testbench for small
// ============================================================
`timescale 1ns / 1ps
...
module tb_pipeline_top_small;
    ...
    initial begin
        $dumpfile("tb_pipeline_top_small.vcd");
        $dumpvars(0, tb_pipeline_top_small);
    end
    ...
    initial begin
        ...
        $display("FAIL absolute timeout in tb_pipeline_top_small.v");
        $finish;
    end
endmodule
