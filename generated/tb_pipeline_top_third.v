// ============================================================
// Module      : tb_pipeline_top_third
// Description : Program-specific RICH-DEBUG testbench for third
...
module tb_pipeline_top_third;
    ...
    initial begin
        $dumpfile("tb_pipeline_top_third.vcd");
        $dumpvars(0, tb_pipeline_top_third);
    end
    ...
    initial begin
        ...
        $display("FAIL absolute timeout in tb_pipeline_top_third.v");
        $finish;
    end
endmodule
